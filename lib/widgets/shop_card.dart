...
import 'package:ambatuflutters/screens/login.dart';
...
class ShopCard2 extends StatelessWidget {
  ...
  const ShopCard2(this.item, {super.key}); // Constructor
...
class ShopCard3 extends StatelessWidget {
  final ShopItem item;

  const ShopCard3(this.item, {super.key}); // Constructor
